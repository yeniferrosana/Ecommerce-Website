<template>
  <v-container fluid>
        ...
        <v-col cols="12" sm="4" class="pl-0">
          <v-card height="250px" tile flat color="#6857e1">
            <v-row>
              ...
              <v-col cols="12" sm="6">
                <v-img src="jacket2.png" max-height="400" max-width="400" contain class="mt-n2"></v-img>
              </v-col>
            </v-row>
          </v-card>
        </v-col>
      ...
      <v-row>
        ...
        <v-col cols="12" sm="3" class="mt-n6 pl-0">
          <v-toolbar flat outlined>
            ...
            <v-spacer></v-spacer>
            <v-badge color="#111111" content="3" class="mr-2"></v-badge>
          </v-toolbar>
        </v-col>
        <v-col cols="3" class="py-0 pr-0 mt-n3">
          <v-card flat outlined tile>
            ...
            <v-list dense class="mt-n5">
              <v-list-item v-for="style in styles" :key="style.tilte">
                <v-list-item-content>
          ...
          <v-card flat outlined tile>
            ...
            <v-chip-group column multiple>
              ...
              <v-chip filter color="#e83427" text-color="white"></v-chip>
            ...
            <v-col cols="12" sm="4" v-for="(clothe, i) in clothes" :key="i" :class="clothe.class">
              <v-hover v-slot:default="{hover}">
                <v-card height="300" align="center" flat outlined tile>
                  ...
                  <v-img :src="clothe.image" width="200" height="200"></v-img>
    ...
    <v-card color="#eff0f2" height="250px" tile flat dark class="d-flex align-center justify-center mt-n10 card2">
      <v-row>
        <v-col cols="12" sm="12">
          <h4 class="text-center black--text mt-10">SUBSCRIBASE A NUESTRO NEWLETTER</h4>
        </v-col>
        <v-col cols="12" sm="12">
        ...
        <v-col cols="12" sm="12">
          <v-card flat color="transparent" class="d-flex justify-center">
            <v-text-field placeholder="Ingrese su correo" rounded class="shrink" background-color="grey" filled append-icon="mdi-email-outline" dense></v-text-field>
          </v-card>
        </v-col>
      </v-row>
    </v-card>
